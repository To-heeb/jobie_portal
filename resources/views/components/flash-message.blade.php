@if(session()->has('success'))
    <div class="alert alert-secondary alert-dismissible fade show" x-data="{show: true}" x-init="setTimeout(() => show = false, 5000)" x-show="show">
...
<div class="alert alert-danger alert-dismissible fade show" x-data="{show: true}" x-init="setTimeout(() => show = false, 5000)" x-show="show">
