		...
		<div class="row">
			...
			<div class="col-xl-12">
				<div class="d-sm-flex align-items-center mb-3 mt-sm-0 mt-2">
					<h4 class="text-black fs-20 me-auto">Posted Jobs</h4>
					<a href="/employer/jobs" class="btn btn-primary light btn-rounded">View More
							...
							<div class="card-body">
								<div class="media">
									...
									<div class="media-body">
										<h6 class="fs-16 text-black font-w600">Job Title</h6>
										<span class="text-primary font-w500">Job Category</span>
									</div>
								</div>
							</div>
						</div>
