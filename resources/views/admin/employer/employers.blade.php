                                ...
                                <tbody id="edit_delete_td">
                                    @foreach ($employers as $employer)	
                                        <tr>
                                            ...
                                            <td>{{$employer->last_name .' '.$employer->first_name}}</td>
                                            <td>{{$employer->company->name ?? "NILL"}}</td> 
                                            <td>{{ucfirst($employer->employer_type)}}</td>
                                            <td>{{$employer->position_in_company ?? "NILL"}}</td>
                                            <td>
                                                <div class="d-flex">
                                                    
                                                    <a href="#" class="btn btn-sm btn-primary sharp shadow me-4" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg" data-id="{{$employer->id}}">View</a>
